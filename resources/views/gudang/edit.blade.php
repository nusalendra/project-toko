...
<div class="row justify-content-center">
  <div class="col-lg-4">
      ...
      <form method="POST" action="/gudang/update">        
          @csrf            

          <input type="hidden" name="id" value="{{ $gudang->id }}">
          
          <div class="form-floating mb-2">
          <input type="text" name="name" class="form-control rounded-bottom" id="name" placeholder="Nama Gudang" value="{{ $gudang->name }}" required autofocus>
